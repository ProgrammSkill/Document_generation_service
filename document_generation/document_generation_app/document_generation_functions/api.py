...
def IndividualAPI():
    ...
    response = {
        ...
        "passport": {
            ...
            "endDate": '2008-05-04T21:09:09.383+00:00',
            "publisher": 'УМВД Казахстана в г. Алматы kfdf d аа 355 ауауааа ц  цуцу цуцуцуцу',
            "registration_address": "г. Алматы, р-н. Бостандский"
        },
        "patent": {
            "serias": 'AC',
            ...
            "publisher": 'УМВД Казахстана в г. Алматы kfdf d аа 355 ауауааа ц  цуцу цуцуцуцу',
            "kind_of_activity": 'string',
            "dateIssue": "2022-05-04T21:09:09.383+00:00",
            "endDate": '2023-04-04T21:09:09.383+00:00',
        },
        'temporary_registration': 'РОССИЯ, 188310, Ленинградская обл, Гатчинский р-н, Гатчина г, Авиатриссы Зверевой ул, Дом 20, Корпус 1, Квартира 5',
        "inn": "4857522812",
