...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Admin\Desktop\Document_generation_service\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Admin\Desktop\Document_generation_service\venv\Scripts\deactivate.nu'
